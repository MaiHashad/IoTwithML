...
We can build an example hello_world binary from the [source code](https://github.com/tensorflow/tflite-micro.git  ) and then run it. This uses a built in pre-trained model.
...
![output1](./images/SineWave1.PNG)


![output2](./images/SineWave2.PNG)